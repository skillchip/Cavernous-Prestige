...
const tests: {
	...
	/************************************************ Stuff *********************************************/
	{
		...
		test: () => {
			let gem = getStuff("Gem"),
				pick = getStuff("Iron Pick");
			let magic = getStat("Magic"),
				mining = getStat("Mining");
			gem.update(1.5);
			magic.current = 0;
	...
	},
	{
		...
		test: () => {
			let ironSword = getStuff("Iron Sword"),
				steelSword = getStuff("Steel Sword"),
				plus1Sword = getStuff("+1 Sword");
			let ironShield = getStuff("Iron Shield"),
				steelShield = getStuff("Steel Shield"),
				plus1Shield = getStuff("+1 Shield");
			let ironArmour = getStuff("Iron Armour"),
				steelArmour = getStuff("Steel Armour"),
				plus1Armour = getStuff("+1 Armour");
	...
	},
	{
		...
		test: async () => {
			...
			revealWholeMap(0);
			setMined(1, 0, "▣");
			zones[0].getMapLocation(1, 0)!.entered = 1;
			setMined(2, 0, ".");
			zones[0].getMapLocation(2, 0)!.entered = 1;
			setMined(3, 0, "♥");
			zones[0].getMapLocation(3, 0)!.entered = 1;
			setMined(3, -1, "╬");
			zones[0].getMapLocation(3, -1)!.entered = 1;
			setMined(3, -2, "*");
			zones[0].getMapLocation(3, -2)!.entered = 1;
			setMined(3, -3, "=");
			zones[0].getMapLocation(3, -3)!.entered = 1;
			setMined(2, -3, "⎶");
			zones[0].getMapLocation(2, -3)!.entered = 1;
			setMined(1, -3, "&");
			zones[0].getMapLocation(1, -3)!.entered = 1;
			setMined(1, -4, "║");
			zones[0].getMapLocation(1, -4)!.entered = 1;
			setMined(0, -4, '"');
			zones[0].getMapLocation(0, -4)!.entered = 1;
			setMined(-1, -4, "(");
			zones[0].getMapLocation(-1, -4)!.entered = 1;
			setMined(-1, -3, ")");
			zones[0].getMapLocation(-1, -3)!.entered = 1;
			setMined(-1, -2, "[");
			zones[0].getMapLocation(-1, -2)!.entered = 1;
			setMined(-2, -2, "]");
			zones[0].getMapLocation(-2, -2)!.entered = 1;
			setMined(-3, -2, "{");
			zones[0].getMapLocation(-3, -2)!.entered = 1;
			setMined(-3, -1, "}");
			zones[0].getMapLocation(-3, -1)!.entered = 1;
			...
			zones[0].getMapLocation(-1, 4)!.entered = 1;
			setMined(-1, 5, "d");
			zones[0].getMapLocation(-1, 5)!.entered = 1;
			setMined(-1, 6, "P");
			zones[0].getMapLocation(-1, 6)!.entered = 1;
			setMined(0, 6, "¢");
			zones[0].getMapLocation(0, 6)!.entered = 1;
			setMined(1, 6, "¥");
			zones[0].getMapLocation(1, 6)!.entered = 1;
			setMined(2, 6, "£");
			zones[0].getMapLocation(2, 6)!.entered = 1;
			setMined(3, 6, "©");
			zones[0].getMapLocation(3, 6)!.entered = 1;
			setMined(3, 7, "Θ");
			zones[0].getMapLocation(3, 7)!.entered = 1;
			setMined(4, 7, "|");
			zones[0].getMapLocation(4, 7)!.entered = 1;
			setMined(5, 7, "<");
			zones[0].getMapLocation(5, 7)!.entered = 1;
			setMined(6, 7, ">");
			zones[0].getMapLocation(6, 7)!.entered = 1;
			drawMap();
			settings.autoRestart = AutoRestart.WaitAll;
			settings.running = true;
			settings.usingBankedTime = true;
