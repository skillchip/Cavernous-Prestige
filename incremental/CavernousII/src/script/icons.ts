...
sodipodi:nodetypes="ccccccc" />` +
	svgEnd;
const repeatInteractSVG =
	svgStart.replace("0 0 100 100", "-10 -10 120 120") +
	`<ellipse
...
transform="rotate(-135)" />` +
	svgEnd;
const repeatListSVG =
	svgStart.replace("0 0 100 100", "10 0 100 110") +
	`<path
style="fill:none;fill-opacity:1;stroke:#000000;stroke-width:20;stroke-miterlimit:4;stroke-dasharray:none;stroke-opacity:1"
transform="rotate(-90)"
sodipodi:type="arc"
...
transform="rotate(-45)" />` +
	svgEnd;
const syncSVG =
	svgStart.replace("0 0 100 100", "0 0 110 100") +
	`<rect
