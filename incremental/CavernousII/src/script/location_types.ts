...
const locationTypes = [
	...
	new LocationType(
		"Mana-infused Rock",
		"¤",
		"A whole bunch of rock.  But this time, it glows!",
		"Mine",
		"Collect Mana",
		storeCompletions,
	...
	new LocationType<"Mana Spring">(
		"Mana Spring",
		"*",
		"Pure mana, flowing out of the rock.  Each time you absorb the mana, the cost to do so next time increases.",
		"Walk",
		"Collect Mana",
		storeCompletions,
		startCollectManaCost
	...
	new LocationType(
		"Strange Machine",
		"♥",
		"A strange machine labelled '{'0':'Clone Machine','1':'Rune Enhancer','2':'Rune Enhancer','3':'Time Stretcher'}'.  What could it do?",
		"Walk",
		"Activate Machine",
		null,
		getNextActivateCost
	...
	new LocationType(
		"Lava",
		"~",
		"A bottomless pit full of lava.  At least, you're not going to be walking on the bottom, so it's bottomless enough for you.  Your bridges might not last very long here, but probably long enough for one clone.",
		"Cross Lava",
		null,
		null,
		null,
	...
	new LocationType(
		"Kudzushroom",
		"♣",
		"A giant mushroom which grows quickly.  It grows so fast each clone needs to make its own way every time. (Growth: 1+{'0':0.1,'2':0.5}t)",
		"Kudzu Chop",
		null,
		null,
		null,
	...
	new LocationType(
		"Springshroom",
		"δ",
		"A giant mushroom which grows quickly.  It seems to continually spray water. (Growth: 1+{'0':0.1,'2':0.5}t)",
		"Chop",
		null,
		null,
		null,
