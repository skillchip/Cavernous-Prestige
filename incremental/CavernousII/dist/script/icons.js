...
ry="37.573414" />` +
    svgEnd;
const hammerSVG = svgStart.replace(/"14"/g, '"22"') +
    `<path
...
sodipodi:nodetypes="ccccccc" />` +
    svgEnd;
const repeatInteractSVG = svgStart.replace("0 0 100 100", "-10 -10 120 120") +
    `<ellipse
...
transform="rotate(-135)" />` +
    svgEnd;
const repeatListSVG = svgStart.replace("0 0 100 100", "10 0 100 110") +
    `<path
style="fill:none;fill-opacity:1;stroke:#000000;stroke-width:20;stroke-miterlimit:4;stroke-dasharray:none;stroke-opacity:1"
transform="rotate(-90)"
sodipodi:type="arc"
...
transform="rotate(-45)" />` +
    svgEnd;
const syncSVG = svgStart.replace("0 0 100 100", "0 0 110 100") +
    `<rect
...
transform="scale(-1)" />` +
    svgEnd;
const noSyncSVG = svgStart.replace("0 0 100 100", "0 0 110 100") +
    `<rect
style="fill:#000000;stroke:#000000;stroke-width:9.93948;stroke-miterlimit:4;stroke-dasharray:none"
width="32.716053"
height="1.9397504"
...
inkscape:original-d="M 90.267782,82.127264 C -109.79121,9.4816321 148.34729,56.074321 50.246312,0" />` +
    svgEnd;
const pauseSVG = svgStart +
    `<rect
