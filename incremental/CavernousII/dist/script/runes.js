...
const runes = [
    new Rune("Weaken", "W", simpleRequire([
        ["Iron Bar", 1],
        ["Gold Nugget", 1]
    ]), 0, () => `This rune weakens any orthogonally adjacent enemies,  decreasing their attack and defense by 1.<br>Requires:<br>{'0':'1 Iron Bar<br>1 Gold Nugget', '1':'2 Iron Bars<br>2 Gold Nuggets'}`, weakenCreatures, null),
    new Rune("Wither", "H", simpleRequire([
        ["Salt", 1],
        ["Iron Ore", 1],
        ["Gold Nugget", 1]
